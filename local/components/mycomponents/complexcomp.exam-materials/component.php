...
$arDefaultUrlTemplates404 = array(
	...
	"exam" => "exam/#PARAM1#/?".$arVariableAliases["PARAM2"]."=#PARAM2#/",
);
...
else
{
	...
	elseif(isset($arVariables["SECTION_CODE"]) && strlen($arVariables["SECTION_CODE"]) > 0)
		$componentPage = "section";
		elseif(isset($arVariables["PARAM1"]) && strlen($arVariables["PARAM2"]) > 0)
			$componentPage = "exam";
	else
		$componentPage = "sections_top";
	...
	$arResult = array(
		...
		"URL_TEMPLATES" => Array(
			...
			"exam" =>  htmlspecialcharsbx($APPLICATION->GetCurPage())."?".$arVariableAliases["PARAM1"]."=#PARAM1#"."&".$arVariableAliases["PARAM2"]."=#PARAM2#",
		),
		"VARIABLES" => $arVariables,
		"ALIASES" => $arVariableAliases
	);
